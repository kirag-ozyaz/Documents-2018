...
namespace Documents.Forms.JournalOrder
{
	public partial class FormJournalOrder : FormBase
	{
		...
		{
			this.method_1();
			this.dataGridViewExcelFilter_0.SearchGrid(this.dataGridViewTextBoxColumn_32.Name, ((FormJournalOrderAddEdit)sender).method_0().ToString(), false);
			this.method_2();
			this.dataGridViewExcelFilter_1.SearchGrid(this.dataGridViewTextBoxColumn_35.Name, ((FormJournalOrderAddEdit)sender).method_0().ToString(), false);
		}
		...
		private void toolStripButton_1_Click(object sender, EventArgs e)
		{
			if (this.tabControl_0.SelectedTab == this.tabPage_0)
			{
				...
				FormJournalOrderAddEdit form = new FormJournalOrderAddEdit(Convert.ToInt32(this.dataGridViewExcelFilter_0.CurrentRow.Cells[this.dataGridViewTextBoxColumn_32.Name].Value), false);
				form.GoToSchema += this.method_4;
				form.SqlSettings = this.SqlSettings;
				form.FormClosed += this.method_5;
				form.MdiParent = base.MdiParent;
			...
			{
				FormJournalOrderAddEdit form2 = new FormJournalOrderAddEdit(Convert.ToInt32(this.dataGridViewExcelFilter_1.CurrentRow.Cells[this.dataGridViewTextBoxColumn_35.Name].Value), false);
		...
		private void toolStripButton_5_Click(object sender, EventArgs e)
		{
			if (this.tabControl_0.SelectedTab == this.tabPage_0)
			{
				if (this.dataGridViewExcelFilter_0.CurrentRow != null)
				{
					FormJournalOrderAddEdit form = new FormJournalOrderAddEdit(Convert.ToInt32(this.dataGridViewExcelFilter_0.CurrentRow.Cells[this.dataGridViewTextBoxColumn_32.Name].Value), true);
					form.GoToSchema += this.method_4;
					form.SqlSettings = this.SqlSettings;
					form.MdiParent = base.MdiParent;
					form.Show();
			...
			{
				FormJournalOrderAddEdit form2 = new FormJournalOrderAddEdit(Convert.ToInt32(this.dataGridViewExcelFilter_1.CurrentRow.Cells[this.dataGridViewTextBoxColumn_35.Name].Value), true);
				form2.GoToSchema += this.method_4;
				form2.SqlSettings = this.SqlSettings;
				form2.MdiParent = base.MdiParent;
				form2.Show();
