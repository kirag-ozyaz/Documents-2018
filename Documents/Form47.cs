...
internal partial class Form47 : FormBase
{
	internal Form47()
	{
	...
	private void method_0()
	{
		...
		base.SelectSqlData(this.zgooKhuuaUJ.tJ_TechnologicalFailures, true, where, null, false, 0);
		this.reportViewerRus_0.RefreshReport();
	}
	...
	private void method_1()
	{
		...
		this.zgooKhuuaUJ = new Class126();
		this.bindingSource_0 = new BindingSource(this.icontainer_0);
		this.radioButton_3 = new RadioButton();
		this.splitContainer_0.Panel1.SuspendLayout();
		this.splitContainer_0.Panel2.SuspendLayout();
		this.splitContainer_0.SuspendLayout();
		((ISupportInitialize)this.zgooKhuuaUJ).BeginInit();
		...
		reportDataSource.Name = "DataSetFailure";
		...
		this.zgooKhuuaUJ.DataSetName = "DataSetFailure";
		this.zgooKhuuaUJ.SchemaSerializationMode = SchemaSerializationMode.IncludeSchema;
		this.bindingSource_0.DataMember = "tJ_TechnologicalFailures";
		this.bindingSource_0.DataSource = this.zgooKhuuaUJ;
		...
		base.Load += this.Form47_Load;
		this.splitContainer_0.Panel1.ResumeLayout(false);
		this.splitContainer_0.Panel1.PerformLayout();
		this.splitContainer_0.Panel2.ResumeLayout(false);
		this.splitContainer_0.ResumeLayout(false);
		((ISupportInitialize)this.zgooKhuuaUJ).EndInit();
