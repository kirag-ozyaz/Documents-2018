...
internal partial class Form26 : FormBase
{
	[CompilerGenerated]
	internal Class119 method_0()
	{
		return this.class119_0;
	}

	[CompilerGenerated]
	private void method_1(Class119 class119_2)
	{
		this.class119_0 = class119_2;
	}

	[CompilerGenerated]
	internal Class119 method_2()
	{
		return this.class119_1;
	}

	[CompilerGenerated]
	private void method_3(Class119 class119_2)
	{
		this.class119_1 = class119_2;
	}
	...
	internal Form26(List<int> list_3 = null)
	{
		
		this.bool_0 = true;
		this.list_1 = new List<Form26.Class118>();
		this.list_2 = new List<Form26.Class118>();
	...
	private void method_6()
	{
		...
		foreach (object obj in dataTable.Rows)
		{
			...
			if (this.list_0 != null && this.list_0.Contains(Convert.ToInt32(dataRow["id"])))
			{
				...
				this.list_1.Add(new Form26.Class118(treeNode2, Convert.ToInt32(dataRow["id"]), (Form26.Enum6)0, false));
				TreeNode treeNode3 = new TreeNode("6-10 кВ");
				treeNode.Nodes.Add(treeNode3);
				this.list_1.Add(new Form26.Class118(treeNode3, Convert.ToInt32(dataRow["id"]), (Form26.Enum6)1, false));
			}
		}
		...
		foreach (object obj2 in dataTable.Rows)
		{
			...
			if (this.list_0 != null && this.list_0.Contains(Convert.ToInt32(dataRow2["id"])))
			{
				...
				this.list_2.Add(new Form26.Class118(treeNode4, Convert.ToInt32(dataRow2["id"]), (Form26.Enum6)1, false));
			}
		}
		foreach (Form26.Class118 parameter in this.list_1)
		{
			new Thread(new ParameterizedThreadStart(this.method_7)).Start(parameter);
		}
		foreach (Form26.Class118 parameter2 in this.list_2)
		{
			new Thread(new ParameterizedThreadStart(this.method_8)).Start(parameter2);
		}
	}
	...
	private void Form26_Shown(object sender, EventArgs e)
	{
		for (;;)
		{
			...
			bool flag = true;
			List<Form26.Class118>.Enumerator enumerator = this.list_1.GetEnumerator();
			try
			{
	...
	{
		if (!(object_0 is Form26.Class118))
		{
			return;
		}
		Form26.Class118 @class = (Form26.Class118)object_0;
		DataTable dataTable = new DataTable("VP_CAbleLine");
		dataTable.Columns.Add("id", typeof(int));
		dataTable.Columns.Add("text", typeof(string));
		base.SelectSqlData(dataTable, true, string.Format("where typeCodeid = {0} and voltage in ({1}) order by text", @class.int_0, (@class.enum6_0 == (Form26.Enum6)0) ? "0.23, 0.4" : "6, 10"), null, false, 0);
		foreach (object obj in dataTable.Rows)
		{
			DataRow dataRow = (DataRow)obj;
			TreeNode treeNode = new TreeNode(dataRow["TExt"].ToString());
			treeNode.Tag = dataRow["id"];
			this.method_9(this.treeView_0, @class.treeNode_0, treeNode);
		}
		Form26.Class118 obj2 = @class;
		lock (obj2)
		{
			@class.bool_0 = true;
		}
	...
	private void method_9(TreeView treeView_1, TreeNode treeNode_0, TreeNode treeNode_1)
	{
		...
		try
		{
			...
			{
				treeView_1.Invoke(new Form26.Delegate53(this.method_9), new object[]
				{
					treeView_1,
					treeNode_0,
					treeNode_1
	...
	private void hgXoxljXfq0_Click(object sender, EventArgs e)
	{
		this.treeView_0.smethod_0(this.toolStripTextBox_0.Text, (Class609.Enum27)0);
	}

	private void toolStripButton_0_Click(object sender, EventArgs e)
	{
		this.treeView_0.smethod_0(this.toolStripTextBox_0.Text, (Class609.Enum27)2);
	}

	private void toolStripButton_1_Click(object sender, EventArgs e)
	{
		this.treeView_0.smethod_0(this.toolStripTextBox_0.Text, (Class609.Enum27)1);
	}
	...
	private void Form26_FormClosing(object sender, FormClosingEventArgs e)
	{
		if (base.DialogResult == DialogResult.OK)
		{
			...
			if (this.treeView_0.SelectedNode.Level == 2 && this.bool_0)
			{
				...
				{
					this.method_3(new Class119(this.dataGridViewExcelFilter_0.CurrentRow.Cells[this.dataGridViewTextBoxColumn_0.Name].Value.ToString(), Convert.ToInt32(this.dataGridViewExcelFilter_0.CurrentRow.Cells[this.dataGridViewTextBoxColumn_1.Name].Value)));
				}
			}
			this.method_1(new Class119(this.treeView_0.SelectedNode.Text, Convert.ToInt32(this.treeView_0.SelectedNode.Tag)));
		}
	}
	...
	private void method_10()
	{
		...
		this.hgXoxljXfq0 = new ToolStripButton();
		...
		this.hgXoxljXfq0.DisplayStyle = ToolStripItemDisplayStyle.Image;
		this.hgXoxljXfq0.Image = Resources.Find;
		this.hgXoxljXfq0.ImageTransparentColor = Color.Magenta;
		this.hgXoxljXfq0.Name = "toolBtnFind";
		this.hgXoxljXfq0.Size = new Size(23, 22);
		this.hgXoxljXfq0.Text = "Поиск";
		this.hgXoxljXfq0.Click += this.hgXoxljXfq0_Click;
		...
		this.toolStripButton_0.Image = Resources.FindPrev;
		this.toolStripButton_0.ImageTransparentColor = Color.Magenta;
		this.toolStripButton_0.Name = "toolBTnFindPrev";
		this.toolStripButton_0.Size = new Size(23, 22);
		this.toolStripButton_0.Text = "Поиск назад";
		...
		this.toolStripButton_1.Text = "Поиск вперед";
		...
		base.FormClosing += this.Form26_FormClosing;
		base.Load += this.Form26_Load;
		base.Shown += this.Form26_Shown;
	...
	[CompilerGenerated]
	private Class119 class119_1;

	private List<Form26.Class118> list_1;

	private List<Form26.Class118> list_2;
	...
	private ToolStripButton hgXoxljXfq0;
	...
	private class Class118
	{
		internal Class118(TreeNode treeNode_1, int int_1, Form26.Enum6 enum6_1 = (Form26.Enum6)1, bool bool_1 = false)
		{
